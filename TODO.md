...
|7        | Perform sentinent analysis | 3-4 days |TBD | If we need to write our own, add a couple more days to Est. completion time|\
|8        | Create Visualizations / PPT | 4-5 days |ALL (TBD) | As this is what we are presenting, we probably want to spend more time on this.|
